...
export default function Hero() {
    return (
        <section className="w-full h-screen flex flex-col justify-between items-start relative overflow-hidden pt-6 px-16 pb-32">
            <Header />
            <video autoPlay loop muted playsInline className="absolute top-0 bottom-0 right-0 left-0 z-0">
                <source src="https://6069178.fs1.hubspotusercontent-na1.net/hubfs/6069178/FGYHJ.mp4" type="video/mp4" />
            </video>
